...
\hspace{0.0cm}I Preface

\hspace{0.5cm} I.I Purpose of this document

\hspace{0.5cm} I.II General principles

\hspace{0.5cm} I.III Terminology

\hspace{0.5cm} I.IV Exceptions

\hspace{0.0cm}

\hspace{0.0cm}1. Naming

\hspace{0.0cm}

\hspace{0.5cm} 1.1 Identifiers

\hspace{0.5cm} 1.2 Packages

\hspace{0.5cm} 1.3 Classes, enumerations, interfaces

\hspace{0.5cm} 1.4 Functions

\hspace{0.5cm} 1.5 Constants

\hspace{0.5cm} 1.6 Non-constant fields (variables)

\hspace{1.0cm} 1.6.1 Non-constant field name

\hspace{1.0cm} 1.6.2 Boolean variable names with negative meaning

\hspace{0.0cm}

\hspace{0.0cm}2. Comments

\hspace{0.5cm} 2.1 General form of Kdoc

\hspace{1.0cm} 2.1.1 Using KDoc for the public, protected, or internal code elements

\hspace{1.0cm} 2.1.2 Describing methods that have arguments, a return value, or can throw an exception in the KDoc block

\hspace{1.0cm} 2.1.3 Only one space between the Kdoc tag and content. Tags are arranged in the order.

\hspace{0.5cm} 2.2 Adding comments on the file header

\hspace{0.5cm} 2.3 Comments on the function header

\hspace{0.5cm} 2.4 Code comments

\hspace{1.0cm} 2.4.1 Add a blank line between the body of the comment and Kdoc tag-blocks

\hspace{1.0cm} 2.4.2 Do not comment on unused code blocks

\hspace{1.0cm} 2.4.3 Do not comment on unused code blocks

\hspace{1.0cm}

\hspace{0.0cm}3. General formatting (typesetting)

\hspace{0.5cm} 3.1 File-related rules

\hspace{1.0cm} 3.1.1 Avoid files that are too long

\hspace{1.0cm} 3.1.2 Code blocks in the source file should be separated by one blank line

\hspace{1.0cm} 3.1.3 Import statements order

\hspace{1.0cm} 3.1.4 Order of declaration parts of class-like code structures

\hspace{0.5cm} 3.2 Braces

\hspace{1.0cm} 3.2.1 Using braces in conditional statements and loop blocks

\hspace{1.0cm} 3.2.2 Opening braces are placed at the end of the line in non-empty blocks and block structures

\hspace{0.5cm} 3.3 Indentation

\hspace{0.5cm} 3.4 Empty blocks

\hspace{0.5cm} 3.5 Line length

\hspace{0.5cm} 3.6 Line breaks (newlines)

\hspace{1.0cm} 3.6.1 Each line can have a maximum of one statement

\hspace{1.0cm} 3.6.2 Rules for line-breaking

\hspace{0.5cm} 3.7 Using blank lines

\hspace{0.5cm} 3.8 Horizontal space

\hspace{1.0cm} 3.8.1 Usage of whitespace for code separation

\hspace{1.0cm} 3.8.2 No spaces for horizontal alignment

\hspace{0.5cm} 3.9 Enumerations

\hspace{0.5cm} 3.10 Variable declaration

\hspace{1.0cm} 3.10.1 Declare one variable per line

\hspace{1.0cm} 3.10.2 Variables should be declared near the line where they are first used

\hspace{0.5cm} 3.11 'When' expression

\hspace{0.5cm} 3.12 Annotations

\hspace{0.5cm} 3.13 Block comments

\hspace{0.5cm} 3.14 Modifiers and constant values

\hspace{1.0cm} 3.14.1 Declaration with multiple modifiers

\hspace{1.0cm} 3.14.2 Separate long numerical values with an underscore

\hspace{1.0cm} 3.15 Strings

\hspace{1.0cm} 3.15.1 Concatenation of Strings

\hspace{1.0cm} 3.15.2 String template format

\hspace{0.0cm}

\hspace{0.0cm}4. Variables and types

\hspace{0.5cm} 4.1 Variables

\hspace{1.0cm} 4.1.1 Do not use Float and Double types when accurate calculations are needed

\hspace{1.0cm} 4.1.2 Comparing numeric float type values

\hspace{1.0cm} 4.1.3 Try to use 'val' instead of 'var' for variable declaration SAY\_NO\_TO\_VAR

\hspace{0.5cm} 4.2 Types

\hspace{1.0cm} 4.2.1 Use Contracts and smart cast as much as possible

\hspace{1.0cm} 4.2.2 Try to use type alias to represent types making code more readable

\hspace{0.5cm} 4.3 Null safety and variable declarations

\hspace{1.0cm} 4.3.1 Avoid declaring variables with nullable types, especially from Kotlin stdlib

\hspace{1.0cm} 4.3.2 Variables of generic types should have an explicit type declaration

\hspace{1.0cm} 4.3.3 Null-safety

\hspace{0.0cm}

\hspace{0.0cm}5. Functions

\hspace{0.5cm} 5.1 Function design

\hspace{1.0cm} 5.1.1 Avoid functions that are too long 

\hspace{1.0cm} 5.1.2 Avoid deep nesting of function code blocks, limiting to four levels

\hspace{1.0cm} 5.1.3 Avoid using nested functions

\hspace{0.5cm} 5.2 Function arguments

\hspace{1.0cm} 5.2.1 The lambda parameter of the function should be placed at the end of the argument list

\hspace{1.0cm} 5.2.2 Number of function parameters should be limited to five

\hspace{1.0cm} 5.2.3 Use default values for function arguments instead of overloading them

\hspace{0.0cm}

\hspace{0.0cm}6. Classes, interfaces, and extension functions

\hspace{0.5cm} 6.1 Classes

\hspace{1.0cm} 6.1.1 Denoting a class with a single constructor

\hspace{1.0cm} 6.1.2 Prefer data classes instead of classes without any functional logic

\hspace{1.0cm} 6.1.3 Do not use the primary constructor if it is empty or useless

\hspace{1.0cm} 6.1.4 Do not use redundant init blocks in your class

\hspace{1.0cm} 6.1.5 Explicit supertype qualification

\hspace{1.0cm} 6.1.6 Abstract class should have at least one abstract method

\hspace{1.0cm} 6.1.7 When using the "implicit backing property" scheme, the name of real and back property should be the same

\hspace{1.0cm} 6.1.8 Avoid using custom getters and setters

\hspace{1.0cm} 6.1.9 Never use the name of a variable in the custom getter or setter (possible\_bug)

\hspace{1.0cm} 6.1.10 No trivial getters and setters are allowed in the code

\hspace{1.0cm} 6.1.11 Use 'apply' for grouping object initialization

\hspace{0.5cm} 6.2 Classes

\hspace{1.0cm} 6.2.1 Use extension functions for making logic of classes less coupled

\hspace{1.0cm} 6.2.2 No extension functions with the same name and signature if they extend base and inheritor classes (possible\_bug)

\hspace{0.5cm} 6.3 Interfaces

\hspace{0.5cm} 6.4 Objects

\hspace{1.0cm} 6.4.1 Instead of using utility classes/objects, use extensions

\hspace{1.0cm} 6.4.2 Objects should be used for Stateless Interfaces

...
#### <a name="s6.1.10"></a> 6.1.10 No trivial getters and setters are allowed in the code
...
#### <a name="s6.1.11"></a> Use 'apply' for grouping object initialization
...
#### <a name="s6.2.1"></a> 6.2.1 Use extension functions for making logic of classes less coupled
...
#### <a name="s6.2.2"></a> 6.2.2 No extension functions with the same name and signature if they extend base and inheritor classes (possible_bug)
...
#### <a name="s6.4.2"></a> 6.4.2 Objects should be used for Stateless Interfaces.

...
class HeaderCommentRuleFixTest : FixTestBase(
    ...
    @Test
    @Tags(Tag(StringWarnings.HEADER_MISSING_OR_WRONG_COPYRIGHT), Tag(StringWarnings.HEADER_WRONG_FORMAT))
    ...
    @Test
    @Tags(Tag(StringWarnings.HEADER_NOT_BEFORE_PACKAGE), Tag(StringWarnings.HEADER_MISSING_OR_WRONG_COPYRIGHT))

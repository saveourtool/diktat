...
class KdocMethodsTest {
    ...
    @Test
    @Tags(Tag("KDOC_WITHOUT_PARAM_TAG"), Tag("KDOC_WITHOUT_RETURN_TAG"), Tag("KDOC_WITHOUT_THROWS_TAG"))
    ...
    @Test
    @Tag("KDOC_TRIVIAL_KDOC_ON_FUNCTION")

...
class DiktatRuleSetFactory(private var diktatConfigFile: String = DIKTAT_ANALYSIS_CONF) {
    ...
    companion object {
        private val log = KotlinLogging.loggerWithKtlintConfig(DiktatRuleSetFactory::class)
    }
}

...
enum class Warnings(private val canBeAutoCorrected: Boolean, private val warn: String) : Rule {
    ...
    KDOC_NO_CONSTRUCTOR_PROPERTY(true, "add @property tag with description in KDoc"),
    KDOC_NO_CONSTRUCTOR_PROPERTY_WITH_COMMENT(true, "replace comment before property with @property tag in KDoc"),

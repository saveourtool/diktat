 ...
 */
internal class DefaultDiktatRuleSetFactory(private var diktatConfigFile: String = DIKTAT_ANALYSIS_CONF) : DiktatRuleSetFactory {
    ...
    override fun invoke(): DiktatRuleSet {
        ...
        val rules = sequenceOf<(List<RulesConfig>) -> DiktatRule>(
    ...
    companion object {
        private val log = KotlinLogging.loggerWithKtlintConfig(DefaultDiktatRuleSetFactory::class)
    }
}

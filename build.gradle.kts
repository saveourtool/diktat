...
val diktatCheck by tasks.creating(JavaExec::class) {
    ...
    args = listOf("**/src/main/kotlin/**/*.kt", "diktat-rules/src/test/kotlin/**/FunctionalTestFile.kt")
}
...
val diktatFormat by tasks.creating(JavaExec::class) {
    ...
    // specify proper path to sources that should be checked here
    args = listOf("-F", "**/src/main/kotlin/**/*.kt", "diktat-rules/src/test/kotlin/**/FunctionalTestFile.kt")
}
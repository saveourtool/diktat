...
Now diKTat was already added to the lists of [static analysis tools](https://github.com/analysis-tools-dev/static-analysis), to [kotlin-awesome](https://github.com/KotlinBy/awesome-kotlin) and to [kompar](https://catalog.kompar.tools/Analyzer/diKTat/0.6.2). Thanks to the community for this support! 
...
2. Load diKTat manually: [here](https://github.com/cqfn/diKTat/releases/download/v0.6.2/diktat-0.6.2.jar)

   **OR** use curl:
   ```bash
   $ curl -sSLO https://github.com/cqfn/diKTat/releases/download/v0.6.2/diktat-0.6.2.jar
   ```
...
buildscript {
    ...
    dependencies {
        classpath("org.cqfn.diktat:diktat-gradle-plugin:0.6.2")
    }
}
...
spotless {
   kotlin {
      diktat("0.6.2").configFile("full/path/to/diktat-analysis.yml")
   }
}
```
</details>
...
```xml
<diktat>
  <version>0.6.2</version> <!-- optional -->
